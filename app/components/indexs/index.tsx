...
import { DEFAULT_VALUE_MAX_LEN, IS_WORKFLOW, getAppInfo } from '@/config'
...
const TextGeneration = () => {
  ...
  const selectedMenu = typeof window !== 'undefined' && localStorage.getItem('selectedMenu')
  const { API_KEY, APP_ID, APP_INFO } = getAppInfo(selectedMenu || 'default')
      ...
      <>
        <div className='flex items-center justify-between shrink-0'>
          <div className='flex items-center space-x-3'>
            ...
            <div className='text-lg font-semibold text-gray-800'>{t('app.generation.title')}</div>
          </div>
